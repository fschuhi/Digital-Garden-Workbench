...
def createSynopsis(haf: HAFEnvironment, talknameLeft, talknameRight, path, out):
    # synopsis create -left "The Place of Samadhi in Metta Practice" -right "Samadhi in Metta Practice" -p "data/2008 vs 2007.csv"
    assert talknameLeft
...
if __name__ == "__main__":
    ...
    # synopsis
        ...
        if not out:
            out = "M:/Brainstorming/Untitled.md"
        createSynopsis(haf, talknameLeft, talknameRight, path, out)
        print("created")
